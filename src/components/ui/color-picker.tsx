...
export const ColorPickerTrigger = React.forwardRef<HTMLButtonElement, ChakraColorPicker.TriggerProps & { fitContent?: boolean }>(
...
export const ColorPickerInput = React.forwardRef<HTMLInputElement, Omit<ChakraColorPicker.ChannelInputProps, "channel">>(
...
export const ColorPickerContent = React.forwardRef<HTMLDivElement, ColorPickerContentProps>(function ColorPickerContent(props, ref) {
...
export const ColorPickerArea = React.forwardRef<HTMLDivElement, ChakraColorPicker.AreaProps>(function ColorPickerArea(props, ref) {
    return (
...
export const ColorPickerEyeDropper = React.forwardRef<HTMLButtonElement, IconButtonProps>(function ColorPickerEyeDropper(props, ref) {
    return (
...
export const ColorPickerRoot = React.forwardRef<HTMLDivElement, ChakraColorPicker.RootProps>(function ColorPickerRoot(props, ref) {
    return (
